package org.k2.processmining.support.mining.algorithm.heuristics.mining;
...
public class HeuristicsMetrics implements Serializable{
...
private int eventsNumber, tracesNumber, instancesNumber;
	...
	//TODO
	private DoubleMatrix2D avgTimes;
	private DoubleMatrix2D bestTimes;
	private DoubleMatrix2D worstTimes;
	private DoubleMatrix2D windowscount;//假设检测是用到的数据
	public static int windowSize=4;
	//TODO
	
	public HeuristicsMetrics(XLogInfo logInfo, HeuristicsMinerSettings settings){
		
		eventsNumber = logInfo.getEventClasses(settings.getClassifier()).size();
		...
		bestEnd = 0;
		//TODO
		avgTimes = DoubleFactory2D.sparse.make(eventsNumber, eventsNumber, 0);
		bestTimes = DoubleFactory2D.sparse.make(eventsNumber, eventsNumber, 0);
		worstTimes = DoubleFactory2D.sparse.make(eventsNumber, eventsNumber, 0);
		windowscount= DoubleFactory2D.sparse.make(eventsNumber, eventsNumber, 0);
		//TODO
	}
...
public HeuristicsMetrics(XLogInfo logInfo, XEventClassifier classifier){
	...
	public DoubleMatrix2D getLongRangeSuccessionCount(){
		return this.longRangeSuccessionCount;
	}
	...
	public DoubleMatrix1D getEventCount(){
	...
	//TODO
	public double getAvgTimes(int x, int y){
		return this.avgTimes.get(x, y);
	}
	public void setAvgTimes(int x, int y, double value){
		this.avgTimes.set(x, y, value);
	}
	public double getBestTimes(int x, int y){
		return this.bestTimes.get(x, y);
	}
	public void setBestTimes(int x, int y, double value){
		this.bestTimes.set(x, y, value);
	}
	public double getWorstTimes(int x, int y){
		return this.worstTimes.get(x, y);
	}
	public void setWorstTimes(int x, int y, double value){
		this.worstTimes.set(x, y, value);
	}
	public DoubleMatrix2D getWindowscount(){
		return this.windowscount;
	}
	public double getWindowscount(int x, int y){
		return this.windowscount.get(x, y);
	}
	public void setWindowscount(int x, int y, double value){
		this.windowscount.set(x, y, value);
	}
	public void incrementWindowscount(int x, int y, double value){
		this.windowscount.set(x, y, (this.windowscount.get(x, y) + value));
	}
