 ...
 * 
 */
public class TransitionSystem extends Formatter {
	// 变量有mineUsetime、nodes、links、traces、allTraces
	public TransitionSystem(HeuristicsNet net, String time, List traces,
							List allTraces) {
...
//		Formatter formatter=new TransitionSystem(net,hm.usedTime,hm.getTraces(),hm.getAlltraces());
//		try
//		   {
//		       PrintStream out = new PrintStream("D:\\testfile\\TransitionSystemOut.txt");
//		       System.setOut(out);
//		   }
