...
<base href="<%=basePath%>">
	...
	<!-- 加载自定义js -->
    <!-- <script type="text/javascript" sorg.k2.processminingning/processMining.js"></script> -->
    <script type="text/javascript" src="/js/raphael.js"></script>
    <!-- <script type="text/javascript" sorg.k2.processminingning/eventLogFile.js"></script> -->
	    ...
	    $(function() {
	    	...
	    	function miningMethodformater(value,row,index){
		  		return '<a href="javacript:void(0);" onclick="org.k2.processmining('+index+');">'+row.name+'</a>';
			}
	    	
	    	var settingTitle;
	    	function org.k2.processmining(index){
	...
	//    		if (row){
	//    			alert('EventAbstractLog ID:'+row.id + "EventAbstractLog NAME:"+row.name);
	//    		}
	    		if(globleIndex == 1){
