<template>
    <div class="merge-list">
      ...
      <div v-for="item in methods" v-if="item.id === selectedId">
        <div v-for="params in item.parameters">
         {{params.name}}:<input type="number" :min="params.minVal" :max="params.maxVal" v-model="params.defaultVal" @blur="change(this.value,params.minVal,params.maxVal)">
        </div>
        <!--<div v-for="params in item.parameters">-->
